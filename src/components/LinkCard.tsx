...
export function LinkCard({ title, description, href, icon: Icon, onClick }: LinkCardProps) {
  if (onClick) {
    return (
      ...
      >
        <div className="absolute inset-x-0 top-0 h-[50%] pointer-events-none" style={{ background: "linear-gradient(180deg, rgba(255,255,255,0.7) 0%, rgba(255,255,255,0.1) 50%, transparent 100%)", borderRadius: "20px 20px 0 0" }} />
        <div className="relative flex h-11 w-11 shrink-0 items-center justify-center rounded-xl text-gray-700" style={{ background: "rgba(255, 255, 255, 0.8)", boxShadow: "inset 0 1px 2px rgba(255,255,255,1), 0 2px 4px rgba(0,0,0,0.04)", border: "1px solid rgba(255,255,255,0.6)" }}>
        ...
        <ChevronRight className="relative h-5 w-5 text-gray-400 transition-all duration-200 group-hover:translate-x-0.5 group-hover:text-gray-600" strokeWidth={2} />
      </motion.button>
    )
  }
